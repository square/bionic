...
from bionic.s3 import upload_to_s3
...
class FileCopierS3:
    ...
    def copy(self, destination):
        ...
        This supports both local and S3 destinations. For the former, we follow cp's
        ...
        if str(destination).startswith("s3://"):
            upload_to_s3(self.src_file_path, str(destination))
        else:
